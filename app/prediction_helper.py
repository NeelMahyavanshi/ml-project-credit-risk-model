...
# Path to the saved model   and its component
MODEL_PATH = "app/artifacts/model_data.joblib"

#  load the model and it's component
...
def prepare_df(age, income, loan_amount, loan_tenure_months,
    ...
    input_data = {
        ...
        "residence_type_Rented" : 1 if residence_type == "Owned" else 0,
...
def calculate_credit_score(input_df, base_score = 300, scale_length = 600):
    ...
    # get reating based on credit score
...
def predict(age, income, loan_amount, loan_tenure_months,
    ...
    input_df = prepare_df(age, income, loan_amount, loan_tenure_months,
            avg_dpd_per_delinquency, delinquency_ratio,
            credit_utilization_ratio, num_open_accounts,
            residence_type, loan_purpose, loan_type)
